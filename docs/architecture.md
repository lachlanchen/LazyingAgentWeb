...
is fail-closed. Current v0.1.19 production enables Agent only through the
...
failure and successor-run state for durable reload and Resume behavior.
...
alone does not authorize deployment. Current v0.1.19 production exposes Agent
